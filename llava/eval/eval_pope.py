    ...
    with open(label_file, 'r', encoding='utf-8') as f:
        for line_num, line in enumerate(f, 1):
            ...
            try:
                ...
                raise RuntimeError(f"Failed to parse JSON in {label_file} at line {line_num}: {stripped}") from e
...
if __name__ == "__main__":
    ...
    with open(args.path_to_all_results, 'w') as f:
